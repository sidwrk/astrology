...
export function ZodiacGridSection() {
  return (
    <section id="zodiac" className="section-shell py-16 sm:py-20">
      <SectionHeading
        eyebrow="Zodiac Overview"
        title="A professional introduction to all twelve zodiac signs"
        description="Explore the key characteristics of each zodiac sign through a clear and professionally presented overview."
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {zodiacSigns.map((sign, index) => (
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br ${sign.accent} opacity-80 transition duration-500 group-hover:opacity-100`}
            />
            <div className="absolute -right-3 top-3 text-6xl text-white/10">
              {sign.glyph}
            </div>
